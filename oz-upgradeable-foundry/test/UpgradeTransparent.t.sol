...
contract _Test is PRBTest {
    ...
    // Test function to check that the contract can only be initialized once.
    function testOnlyInitializeOnce() public {
        // Expect a revert with the message "Initializable: contract is already initialized".
        vm.expectRevert("Initializable: contract is already initialized");

        // Try to initialize the wrapped proxy contract again with a value of 100.
        wrappedProxyV1.initialize(100);
    }
